...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-lightCard dark:bg-darkCard p-2 text-gray-600 dark:text-gray-400 shadow-card",
      className
    )}
    {...props}
  />
